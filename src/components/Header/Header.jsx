...
export default function Header({ isSidebarOpen, setIsSidebarOpen }) {
    ...
    return (
        ...
        >
            ...
            <Sidebar isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen} openLogoutModal={openModal} />

            <a href="/">
                <img className={styles['header__logo']} src={isDarkMode ? darkLogo : lightLogo} alt="Page logo" />
            </a>
