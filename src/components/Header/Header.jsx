...
export default function Header() {
    ...
    return (
        <nav className={styles.header}>
            ...
            {/* prettier-ignore */}
            <svg id="searchIconMobile" className={styles['header__search-icon']} aria-label="search icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className={styles['header__log-out-btn']}>Log out</p>
