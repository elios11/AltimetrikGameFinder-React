export default function LogoutModal() {
    return (
        <dialog id="logoutModal">
            ...
            <button className="primary-button" id="confirmLogout">
                Yes
            </button>
            <button className="active-page" id="cancelLogout">
                No
            </button>
        </dialog>
    );
